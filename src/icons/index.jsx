...
export function RowIcon({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          opacity="0.1"
          d="M3 8.976C3 4.05476 4.05476 3 8.976 3H15.024C19.9452 3 21 4.05476 21 8.976V12H3V8.976Z"
          fill="#fff1d4"
        ></path>{" "}
        <path
...
export function FaceIcon({ className }) {
  return (
    <svg
      fill="#fff1d4"
      viewBox="0 0 32 32"
...
export function TwitIcon({ className }) {
  return (
    <svg
      viewBox="0 -2 20 20"
      version="1.1"
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {" "}
        <title>twitter [#fff1d4154]</title> <desc>Created with Sketch.</desc>{" "}
        <defs> </defs>{" "}
        <g
          id="Page-1"
          stroke="none"
...
export function SetIcon({ className, onClick }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function DeleteIcon({ className, onClick }) {
  return (
